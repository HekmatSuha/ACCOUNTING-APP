...
from .views.admin import AdminAccountViewSet, AdminPlanViewSet
...
urlpatterns = [
    ...
    path('auth/invitations/<str:token>/accept/', InvitationAcceptanceView.as_view(), name='invitation-accept'),
